...
PACKAGES_CRAN <- c('clue', 'colorRamps', 'devtools', 'dplyr', 'fastmap', 'gplots', 'igraph', 'installr', 'kableExtra', 'knitr', 'kohonen', 'MASS', 'miscTools', 'pheatmap', 'png', 'Radviz', 'RColorBrewer', 'RcppParallel', 'readr', 'rmarkdown', 'Rtsne', 'scales', 'shiny', 'statmod', 'tibble', 'umap', 'uwot', 'yaml')
